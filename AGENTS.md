...
**Explicit user requirement, 2026-09-09:** the regular implementation AI owns research, reverse-engineering, implementation and validation by default. Daybreak is a specialist escalation destination, not the automatic owner of all binary analysis or difficult tasks. The DB-01–06 labels describe subjects; they do not assign a model.
