...
- [ ] Settings — R8-020 restores exact `visual_metrics_config_get/save`, native false/false defaults and shared per-profile runtime persistence. Recover remaining retained update/feedback/settings behavior; do not restore account/authentication-purpose settings or UI.
