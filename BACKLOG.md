...
- [ ] **Ghost positive-row acceptance (B03/B13/B14/C01):** implementation and clean full-world scans are ready. Owner deferred positive-row proof until 2026-09-24. Rerun unchanged only when authentic Ghost rows exist.
