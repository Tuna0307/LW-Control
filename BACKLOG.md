...
- [ ] Recover exact descriptor/proof/ticket representation and validation rules.
  ...
  - [ ] Recover the remaining exact descriptor field semantics, response/proof producer and signing inputs/claim mapping, ticket producer/signing inputs, `LWLT2` extra-field meaning, ownership/consumption protocol, helper `0x14033C51B` semantics and outer-host child argument construction before closing the parent item.
