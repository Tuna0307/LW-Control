...
- [ ] Settings — R8-020 restores exact visual-metrics config persistence; R8-021 restores the exact nine-field native `update_status` idle envelope for reference 0.3.1. Recover feedback and full updater check/download/open behavior; do not restore account/authentication-purpose settings or UI.
