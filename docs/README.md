...
- Live Truck/Dispatch plunder and Alliance-share acceptance: suitable targets plus explicit authorization required.
...
- older sections of `live-test-handoff.md` replaced by the current owner-test list
