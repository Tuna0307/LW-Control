...
- [`../evidence/lwbridge-implementation/2026-09-08-r6-map-query-boolean-filters.json`](../evidence/lwbridge-implementation/2026-09-08-r6-map-query-boolean-filters.json) records `LWB-R6-006`: unique, byte-adjacent verified-binary field/predicate pairs for dispatch/ghost `specialOnly` and truck/railway `reindeerOnly`, with both filters implemented and offline-tested.
