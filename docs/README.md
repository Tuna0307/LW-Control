...
- [`../evidence/lwbridge-implementation/2026-09-08-r6-map-quality-special-ur-exclusion.json`](../evidence/lwbridge-implementation/2026-09-08-r6-map-quality-special-ur-exclusion.json) and its [focused static excerpt](../evidence/lwbridge-implementation/2026-09-08-r6-map-quality-special-ur-exclusion.txt) record `LWB-R6-012`: the ordinary `quality` branch immediately applies `isSpecialURQuality = 0`, proving special-UR/reindeer rows are excluded from ordinary quality matching. Numeric ordinary-quality binding remains blocked.
