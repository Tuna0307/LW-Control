...
**Current delivery:** `LWB-PM13-008` now implements and offline-verifies that passive saved Resource Search/reopen package. The repo-root `.cmd` entry point, collector, passive native-host Search/render recorder and owner guide passed the 2026-09-11 checkpoint review and are ready for the passive saved Search/reopen owner check; the owner has not yet been asked to start. Fresh acquisition remains SB-97 BLOCKED/NOT_RUN and is not part of the package.
