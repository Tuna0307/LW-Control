...
| Settings | PARTIAL backend / original UI contract recovered | R8-020 restores visual-metrics config persistence; R8-021 restores the exact native nine-field `update_status` idle envelope for reference 0.3.1. Feedback plus updater check/download/open remain incomplete/fenced |
