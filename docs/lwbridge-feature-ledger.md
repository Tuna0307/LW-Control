...
R7-130 live results show the current optimization reduced representative Truck and Monster scans to ~74.7 s and ~77.8 s respectively while preserving exact 2,500 logical blocks / 10,000 AOI cells and zero failed/unread. No further evidence-backed safe optimization is currently known.
