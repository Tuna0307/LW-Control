...
2. Restore `map_search` filter ownership and remove rebuild-added Monster/Resource level semantics.
3. Roll Auto Scan back to the original scheduler/state machine, then restore Scheduled Plunder.
