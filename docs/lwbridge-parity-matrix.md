...
**Current through:** `LWB-R8-021`, 2026-09-25
...
| Settings | PARTIAL backend / original UI contract recovered | R8-020 restores visual-metrics config/defaults and persistence; R8-021 restores exact native `update_status` idle fields/defaults for reference 0.3.1 | Recover feedback and complete updater check/download/open semantics; keep account/auth settings excluded |
