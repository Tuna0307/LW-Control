...
6. Whole-program backend parity for Automation, Squads/AFK, City Layout, Hotkeys, Mini-games and Settings. City Layout draft persistence is restored in R8-018; R8-019 restores Hotkey config; R8-020 restores Settings visual-metrics config/defaults; R8-021 corrects the native nine-field updater idle status for reference 0.3.1. City Layout gameplay providers, Hotkey actions, feedback/full updater behavior, and remaining Automation/Squads/Mini-game handlers remain incomplete.
