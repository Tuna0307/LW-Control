...
6. Whole-program backend parity for Automation, Squads/AFK, City Layout, Hotkeys, Mini-games and Settings. City Layout draft persistence is now restored in R8-018 (`draft_get/save/clear`); five gameplay-facing handlers remain missing/protected. See `docs/reviews/2026-09-24-r8-city-layout-exact-contract.md` and `docs/reviews/2026-09-25-r8-018-city-layout-draft-persistence.md`.
