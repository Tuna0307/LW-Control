...
## Web -> Sol handoff refresh — 2026-09-11

**RECOVERED / read-only current-client identity, not live feature proof.** `tools/inspect_official_runtime.py` refreshed the installed build for the PM13-04 Sol handoff at `2026-09-11T04:16:34Z`; durable output is [`2026-09-11-web-sol-handoff.json`](../evidence/official-runtime/2026-09-11-web-sol-handoff.json), SHA-256 `9ae2b9cb8ef5c9d9cd447bef72f912c1a311929c7ed077d9f1ae92b5eb80440f`. App/build `1.0.361/1078`, xLua SHA-256 `21eb704afdb7e528f4b90fa1b90bf414c221b06ba990d625aaaaed31b292740f`, `Assembly-CSharp.rdl` SHA-256 `871efe06819fbac438413eb96b7df8193d0be56094f3a44d5ff141e6219adcbd`, and active v14 `LWScripts.data` SHA-256 `09ddc4d1727bc0676ef6320db79814852cacc5c82b53551c703722052ebdbace` still match the bounded resource helper's enforced current-client gates. The latest table has advanced to `table_39228_42accd8c943eaaf0b0d6b39a4cefc9de.data`, SHA-256 `3d51242493f65cc84d5c0721f057f9c721ed23a6f861a5bf11d52e287440f5b6`; that table identity is recorded but is not an input to the bounded helper fingerprint and does not resolve the still-unknown resource-type/name mapping. `tools/run_live_resource_probe.py --check-only` passed against these bytes without changing installed files.
