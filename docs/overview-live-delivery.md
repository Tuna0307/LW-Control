...
**Owner update, 2026-09-16:** Last War advanced Lua content v16 -> v17 and exposed the remaining exact-package pin. `LWB-OVR-015` replaces it with a fail-closed critical-anchor compatibility policy and TECHNICALLY LIVE-PROVES current-v17 manual Launch/Close plus Open-games-at-startup/Close with exact restoration. Owner visual Home retest is next before the broader UI pass continues. S03 full Refresh Status and S06 travel remain deferred.
...
Current extension, 2026-09-12: O04/O05 remain technically live-proven/owner-visible accepted under `LWB-OVR-010/011`. The earlier next-feature transition was superseded by review 16; PM16-02/01 corrections are now delivered and PM16-03 evidence is reconciled. Whole Overview still has shared S02/S03/S06 gaps, so this checkpoint returns to PM/owner rather than advancing to Player City, Map Data or cross-server implementation.
