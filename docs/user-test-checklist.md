...
4. Explicitly authorized state-changing Treasure/Alliance acceptance when suitable safe targets exist. Scheduled Truck/Dispatch Plunder was retired in R7-149.
