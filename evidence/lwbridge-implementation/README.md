...
- `2026-09-24-r8-lwke1-independent-recovery.json` — preserves the independent package-key research that closes the exact ECDH/TRUNCATE KDF, generic envelope AES-GCM primitive, `LWAT2` authorization context and manifest separation while leaving exact `LWKE1` field mapping/AAD `PROTECTED_UNKNOWN`.
