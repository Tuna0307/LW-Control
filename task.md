...
- **Map progress:** `LWB-R6-003/004/005` establish default persisted search, eight frontend query families/response consumers, and implemented alliance/no-alliance, resource/monster name-key and truck/railway item filters. Preserve that subset. Remaining predicates, options/summary aggregation, export, native keys, scan ingestion and publication remain open.
