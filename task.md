...
- **ACTIVE FUNCTION:** finish resource scan -> storage -> normal Resource Search/display -> second fresh refresh -> reopen. PM13-01/01b/03/02 are complete; PM13-04 is the active final gate in [the implementation handoff](docs/implementation-handoff.md). Do not skip it to begin unrelated research. PM12-A/C retain bounded acceptance, PM12-B lifecycle closure is restored, and PM12-D remains open only for the live normal-window outcome.
