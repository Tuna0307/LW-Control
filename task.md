...
- **Next critical work:** preserve the completed R4 host matrix and move to R5 launch/bootstrap + xLua ABI recovery while continuing independent R6 offline Map Data contracts. AMD64 machine validation is implemented; exact xLua ABI selection is not.
